  ...
  <div class="container">
    <div class="section">
      ...
      <div class="row form-row">
        <form class="col s12" id="filter-cancelled-form" action="filter-cancelled.php" method="post">
          <div class="row">
  ...
  <div class="container">
    <div class="section">
      ...
      <div class="row">
        ...
        <h5 class="pad-bot center-align">Cancelled/Rejected Appointments Report</h5>

        <div class="col s12 m12">
          <h6 class="pad-bot center-align">Cancelled/Rejected Appointments (Number of Appointments - Bar)</h6>
